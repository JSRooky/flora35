...
import { AreaIcon, BufferIcon, ClockIcon, ClustersIcon, DatabaseIcon, DenseIcon, GlobeIcon, ListIcon, OoptIcon, PointIcon, PolygonIcon, RadiusIcon, StatusIcon, SubmitIcon, YearIcon } from "../images/buttons";
