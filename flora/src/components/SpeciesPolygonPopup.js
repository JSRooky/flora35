...
import { EyeIcon, EyeOffIcon, TrashIcon } from "../images/buttons";
            ...
            <div className="species-polygon-actions">
              ...
              {builtPolygons.length > 0 && (
                <button
                  ...
                  title="Сбросить всё"
                >
                  <TrashIcon className="species-polygon-icon-svg" aria-hidden="true" focusable="false" />
                </button>
              )}
            </div>
          </div>
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="species-polygon-areal-actions">
                          ...
                          >
                            {isHidden ? <EyeOffIcon className="species-polygon-icon-svg" aria-hidden="true" focusable="false" /> : <EyeIcon className="species-polygon-icon-svg" aria-hidden="true" focusable="false" />}
                          </button>
                          <button
                            type="button"
