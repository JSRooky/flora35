...
export const EXPERIMENTAL_FEATURES = {
  [EXPERIMENTAL_FEATURE_IDS.COMPARE]: {
    ...
    title: "Сравнение",
    message:
      "Функция «Сравнение» экспериментальная и находится в разработке. Результаты могут быть неточными."
  },
  [EXPERIMENTAL_FEATURE_IDS.ANALYSIS]: {
    id: EXPERIMENTAL_FEATURE_IDS.ANALYSIS,
    title: "Анализ",
    message:
      "Функция «Анализ» экспериментальная и находится в разработке. Результаты могут быть неточными."
  }
};
