...
export const PANEL_TASKBAR_META = {
  ...
  [TASKBAR_PANEL_IDS.REPORT]: { title: "Отчёт", icon: "download" },
  [TASKBAR_PANEL_IDS.ANALYSIS]: { title: "Анализ", icon: "analysis" },
...
export const PANEL_TASKBAR_MODULE_ID = {
  ...
  [TASKBAR_PANEL_IDS.REPORT]: null,
  [TASKBAR_PANEL_IDS.ANALYSIS]: null,
