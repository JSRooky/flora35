...
Щелкните кнопку **Ввод списком**. Откроется окно ввода нескольких пар координат. Введите нужные координаты в следующем виде:

широта долгота (разделяйте широту и долготу **пробелом**), например:
