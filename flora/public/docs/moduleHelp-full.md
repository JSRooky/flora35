...
- Выделение субъектов и буфер сразу становятся фильтром карты: они появляются в угловой кнопке **Фильтры**. Оттуда же выборку точек внутри контура (и сами контуры) можно сохранить во временный слой. Если **Выборочный поиск** открыт при выделенных на карте субъектах, кнопка **Во временный слой** в этом окне кладёт найденные точки в тот же слой, что и контуры.
