...
- Клик по субъекту при показе всех регионов выделяет его и открывает подсказку: **Добавить** позволяет кликать ещё регионы, **Изолировать** оставляет на карте только выбранные. Если контуры уже изолированы, **Добавить** снова показывает все субъекты, чтобы добрать выделение.
...
- Выделение субъектов и буфер сразу становятся фильтром карты: они появляются в угловой кнопке **Фильтры**. Оттуда же выборку точек внутри контура (и сами контуры) можно сохранить во временный слой.
